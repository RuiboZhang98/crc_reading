...
//outflow rate vector for the main chain
const long double rate4[6] = {rLOH*APC_mult1, 0.5*nAPC*u*APC_mult2, nKRAS*u*KRAS_mult, rLOH, 0.5*nP53*u};
...
//static const int traj = 10;  //the number of trajectories that are saved
//static const int total_runs = 1000; //the number of runs for each thread
